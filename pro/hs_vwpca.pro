...
;   2016-04-14 Tiny modification by Song Huang
;-
;****************************************************************************************;
...
FUNCTION HS_VWPCA, dataarr, namplitudes, variances, pcs, meanarr, evalues, errarr=errarr, params=params, $
...
; Number of objects to use in initialisation of PCA
    nobj_init = MIN([ceil(nobj / 100.),200.])
