pro list_ratio_test 
    ...
    for ii = 0, ( n_list1 - 1 ), 1 do begin 
        ...
        for jj = 0, ( n_list2 - 1 ), 1 do begin 
            ...
            ind_ratio_trend_mius, index1, index2, $
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
pro ind_ratio_trend_mius, index1, index2, $
    fac1=fac1, fac2=fac2, pow1=pow1, pow2=pow2, $
    ...
    if N_params() lt 1 then begin 
        print,  'Syntax - ind_ratio_trend_mius, index1, index2' 
        return
    endif
    ...
    index_use = where( ( ssp_index.age GE 2.99 ) AND $
        ...
        ( ssp_index.metal GT -0.5 ) AND $
        ( ssp_index.slope LT 2.5 ) )
    ...
    ratio_sep = ( ( max_ratio - min_ratio ) / 40.0 )
